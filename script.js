function showMessage(response) {
  ...
  if (response === "No") {
    ...
    document.getElementsByClassName("image")[0].src = "images/lick.jpg";
    ...
    document.getElementById("question").textContent =
      "Hahahahaha...Nice try, but you can't escape that easily my cute ass lady😂😂 ! ";
  ...
  if (response === "Yes") {
    ...
    yesMessage.textContent = "Yeeessssss! See you super soonnn, My Cute Plum Cake🎂🍑";
